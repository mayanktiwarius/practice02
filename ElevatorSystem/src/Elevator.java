...
public class Elevator {
	...
	private Queue<Request> upQueue = new PriorityQueue<Request>(10, upComparator);
	private Queue<Request> currentQueue = upQueue;
	private Queue<Request> downQueue = new PriorityQueue<Request>(10,downComparator);
	...
	private void preProcessNextQueue() {
		if (getLowestTimeUpQueue() > getLowestTimeDownQueue()) {
			...
			upQueue = new PriorityQueue<Request>(10, upComparator);
		} else {
			this.direction = Direction.DOWN;
			currentQueue = downQueue;
			downQueue = new PriorityQueue<Request>(10, downComparator);
		}
	}
